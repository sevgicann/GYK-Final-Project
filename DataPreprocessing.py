...
crop_recommendation = pd.read_csv(r"C:\Users\Mehdiye\Desktop\TURKCELL PROJE\TerraMind\GYK-Final-Project\csv_doc\Crop_recommendation.csv")
print(crop_recommendation.head())


crop_yield = pd.read_csv(r"C:\Users\Mehdiye\Desktop\TURKCELL PROJE\TerraMind\GYK-Final-Project\csv_doc\crop_yield.csv")
print(crop_yield.head())


data_core = pd.read_csv(r"C:\Users\Mehdiye\Desktop\TURKCELL PROJE\TerraMind\GYK-Final-Project\csv_doc\data_core.csv")
